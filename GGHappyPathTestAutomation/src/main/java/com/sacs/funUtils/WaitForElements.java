...
import com.sacs.exception.ReasonsTimeOutException;
...
public abstract class WaitForElements {
	...
	private final int poolFlag=2;
	protected long WAIT = 30;
...
*/		}
	...
	public boolean waitForTextPresent(By locator, 
		...
		{
		while(flag==false && i<=poolFlag){
		if (driverWait.until(ExpectedConditions.textToBePresentInElementValue(locator,
				sText))) {
