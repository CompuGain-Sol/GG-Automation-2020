...
public class CustomReport {
	...
	public void customizedReport(String sExpected , String sActual,
			List<String> statusValue,WebDriver driver,String sTestcaseName, String sdescription) {
		this.driver = driver;
	...
	public void customizedReport(boolean sExpected,String expected,String actual,List<String> statusValue,WebDriver driver,String sTestcaseName,String sdescription) {
		this.driver = driver;
		//		RTM rtm = new RTM();
