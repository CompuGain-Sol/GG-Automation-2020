 ...
 *
 */
public class  SendMail implements SACSSetup
{    
	private static Logger logger = Logger.getLogger(SendMail.class);
	//private LoginStep stepdef= new LoginStep();
	...
	final Properties props = new Properties();
		...
		//msg.setSubject(reportOutput.get("SuiteName")+"-Execution on "+getAutomationBrowser().toUpperCase());
		msg.setSubject("SACS UI-Automation Sanity Report on Build No : 78.12.23.45");
	...
	*/	
		...
		firstpart= "<html><body>"+body.toString()+
				...
				"<th colspan=10 bgcolor=#E0E6E0>"+"SACS UI-Automation Execution Report</th>"+
				...
				"+<table style="+"width:100% border=6"+">"+
				"<th colspan=10 bgcolor=#E0E6E0>"+"Group Wise Report</th>"+
				"<tr>"+"<b><Center>" +
				"<td>Sno</td>"+
				"<td>EpicLink</td>"+
				"<td>Total Cases</td>"+
		...
		fourthpart= "</table><br>"+"<p>"+"For any querys email : support@compugain.com </p>";		
		thirdpart= "</body></html>";
		...
		messageBodyPart.setFileName(FileUtils.getFile(filename).getName().replace(".zip", ".txt"));
