...
public class PieChartCreation {
	...
	public static void pieChartReport(int passed,int failed,int skipped)
	{
		...
		JFreeChart piechart = ChartFactory.createPieChart("SACS UI-Automation Report", pieDataset, true, true, false);
		...
		try {
			ChartUtilities.saveChartAsJPEG(new File(getFilePath("/src/test/resources/ExecutionReport.jpeg")), piechart, 400, 400);
